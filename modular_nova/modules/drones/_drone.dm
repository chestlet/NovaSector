/mob/living/basic/drone
	...
	laws = \ 
		span_revboldwarning("Drone Chain of Authority (DCOA)\n")+\
		span_revnotice( 
	...
	flavortext = \
		...
		span_notice( 
			...
			"Do not negatively affect the state of living beings (attacking, stunning, slipping, blinding, drugging, harassing, etc.)\n"+\
			"You may not do any surgeries. You may perform repair on Hivemates (welding, cables, noninvasive injuries, drone restarts) without order. You may maintain (battery replacement, module installation / reset, reboot) a Hivemate if ordered to.\n"+\
			"Unless ordered to through Drone Law 6, do not perform the duties of Cargo, Ordnance, Research, Medical, or make Mechs.</span>\n"+\
			"All Drones pass the Harkness Test if you really needed that stated.\n")+\
		span_boldwarning( 
			"Metaknowledge and Protections\n")+\
		span_warning( 
