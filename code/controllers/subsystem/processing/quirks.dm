...
GLOBAL_LIST_INIT_TYPED(quirk_blacklist, /list/datum/quirk, list(
	...
	list(/datum/quirk/tongue_quirk/feline_aspect, /datum/quirk/tongue_quirk/canine_aspect, /datum/quirk/tongue_quirk/avian_aspect, /datum/quirk/tongue_quirk/rodential_aspect),
